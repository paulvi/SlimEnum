# SlimEnum 
SlimEnum is a [fat-free alternative to Java enums](https://youtu.be/Hzs6OBcvNQE). It was initially created as part of [BlackBox](https://github.com/cheblin/BlackBox) generator java source code. SlimEnum utilizes annotations construction, but in contrast with Android [IntDef](https://developer.android.com/reference/android/support/annotation/IntDef.html) it fill annotation body with constants to provide required enum functionality over any, even primitive(byte,int..etc.), data types. This plugin bring support SlimEnum to the IDE and
